  ...
  it("should render with images", () => {
    ...
    render(
      <ReportCategory
        ...
        categoryMainNumber={
          fakeUserReport.zip_code ||
          fakeData.principal.based_on_rent ||
        ...
        categorySecondNumber={
          fakeUserReport.location ||
          fakeData.principal.goal_principal ||
  ...
  it("should render information about monthly costs depending on the props passed in", () => {
    ...
    render(
      <ReportCategory
        ...
        categorySecondNumber={
          fakeUserReport.location ||
          fakeUserReport2.goal_principal ||
          fakeData.monthly.estimated_true_monthly ||
          fakeData.downpayment.down_payment_saved
        }
        categoryID={fakeKey + 1}
