      ...
      <div className="inner-container">
        <div className="info-container">
          <div className="info-box">
            <h2 className="info">
              You may have some questions about some terms I present in the
              questions. Don't worry! I'll try to help you understand them!
            </h2>
          </div>
        </div>
        ...
        <div className="action-survey">
          <div className="action-container">
            <h4 className="title-2 action">
              Enter your numbers and I'll do the math...
            </h4>
          </div>
        </div>
        ...
        <div className="survey-box">
          <div className="survey">
            ...
            <ul>
              ...
              <li className="item">
                {" "}
                - Your housing expenses should be 29% or less. This is for
                things like insurance, taxes, maintenance, and repairs.
              </li>
              <li className="item">
                {" "}
