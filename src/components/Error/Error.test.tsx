...
describe('Error', () => {
  it('all element containers should render accordingly', () => {
    ...
    render(
      <BrowserRouter>
        <Error 
          errorMessage={'here is an error for you'}
          errorNum={404}
        />
      </BrowserRouter>
    )
  ...
  it('should render a 404 erro by default', () => {
    ...
    const errorNumber =screen.getByRole('heading', {name: /here is an error for you/i})
  ...
  it('should render a different error message', () => {
    ...
    render(
      <BrowserRouter>
        <Error 
          errorMessage={'here is different error'}
          errorNum={205}
        />
      </BrowserRouter>
    )
    ...
    const errorNumber =screen.getByRole('heading', {name: /here is different error/i})
