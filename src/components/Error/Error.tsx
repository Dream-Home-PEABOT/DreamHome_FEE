    ...
    <section className="error-section">
      <div className="container">
        ...
        <div className="message--box" data-testid="message box">
          ...
          <h1 style={{fontSize: '2em'}} className="error-message" data-testid='error message'>
            {errorMessage}
          </h1>
        </div>
        <div className="err-box-2">
          <img  data-testid='error image 1' src={bkg_img} alt="" className="error-image"/>
        </div>
        <div className="err-box">
          <img  data-testid='error image 2' src={error_img} alt="" className="error-image"/>
        </div>
      </div>
    </section>
